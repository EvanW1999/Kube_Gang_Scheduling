...
PROFILER_SHARE_INCREMENT: int = WORKLOAD_PROFILER_SECTION.as_int("share_increment")
...
SIMULATION_WORKLOAD_INCREMENT: int = STRESS_NG_SECTION.as_int("workload_increment")

# Gang scheduling config variables
GANG_SCHEDULING_SECTION: Section = CONFIG["gang-scheduling"]
GANG_SCHEDULING_STARTING_SHARES: int = GANG_SCHEDULING_SECTION.as_int("starting_shares")
GANG_SCHEDULING_MAX_SHARES: int = GANG_SCHEDULING_SECTION.as_int("max_shares")
GANG_SCHEDULING_SHARE_INCREMENT: int = GANG_SCHEDULING_SECTION.as_int("share_increment")
GANG_SCHEDULING_TOTAL_SHARES: int = GANG_SCHEDULING_SECTION.as_int("total_shares")
GANG_SCHEDULING_WINDOW_SIZE: int = GANG_SCHEDULING_SECTION.as_int("window_size")
